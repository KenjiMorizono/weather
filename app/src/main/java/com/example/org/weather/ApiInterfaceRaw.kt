...
class ApiInterfaceRaw {
    companion object {
        ...
        fun GetHistoricalStats(lat: Double, lon: Double, unit: String, minuteTimeStep: Int, startTime: String, endTime: String, fields: List<String>, completionHandler: (response: String?) -> Unit) {
        ...
        fun GetNowcastStats(lat: Double, lon: Double, unit: String, minuteTimeStep: Int, startTime: String, endTime: String, fields: List<String>, completionHandler: (response: String?) -> Unit) {
        ...
        fun GetHourlyStats(lat: Double, lon: Double, unit: String, startTime: String, endTime: String, fields: List<String>, completionHandler: (response: String?) -> Unit) {
        ...
        fun GetDailyStats(lat: Double, lon: Double, unit: String, startTime: String, endTime: String, fields: List<String>, completionHandler: (response: String?) -> Unit) {
